...
def create_btp_service(btpUsecase, service):
    ...
    command = "btp create services/instance --subaccount " + btpUsecase.accountMetadata.get(
        "subaccountid") + " --service " + service.instancename + " --plan " + service.plan + " --offering-name " + service.name
