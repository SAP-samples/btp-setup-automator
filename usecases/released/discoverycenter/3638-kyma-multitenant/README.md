...
```bash
./btpsa -parameterfile 'usecases/released/discoverycenter/3638-kyma-multitenant/parameters_trial.json' -usecasefile 'usecases/released/discoverycenter/3638-kyma-multitenant/usecase_trial.json' -subaccountname 'trial' -globalaccount '<your global account subdomain as shown in the SAP BTP cockpit>' -myemail '<your email address>'
```
