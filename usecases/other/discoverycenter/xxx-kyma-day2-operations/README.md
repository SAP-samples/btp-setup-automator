...
The current script was designed to setup the account and spin up the application which is used by the Discovery Center Mission, [TODO enter the right link](https://discovery-center.cloud.sap/missiondetail/3683/3726/). 
...
```bash
./btpsa -parameterfile 'usecases/other/discoverycenter/xxx-kyma-day2-operations/parameters.json' -globalaccount '<your global account subdomain as shown in the SAP BTP cockpit>' -myemail '<your email address>'
```

### Trial Accounts

```bash
./btpsa -parameterfile 'usecases/other/discoverycenter/xxx-kyma-day2-operations/parameters_trial.json' -usecasefile 'usecases/other/discoverycenter/xxx-kyma-day2-operations/usecase_trial.json' -subaccountname 'trial' -globalaccount '<your global account subdomain as shown in the SAP BTP cockpit>' -myemail '<your email address>'
```
...
```bash
./btpsa -parameterfile 'usecases/other/discoverycenter/xxx-kyma-day2-operations/parameters.json' -globalaccount '<your global account subdomain as shown in the SAP BTP cockpit>' -myemail '<your email address>' -region 'region for your subaccount'
```
