...
```bash
./btpsa -parameterfile 'usecases/other/discoverycenter/3638-kyma-multitenant/parameters_trial.json' -globalaccount '<your global account subdomain as shown in the SAP BTP cockpit>' -myemail '<your email address>'
```
