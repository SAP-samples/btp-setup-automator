...
./btpsa -parameterfile 'usecases/other/discoverycenter/3638-kyma-multitenant/parameters.json' -globalaccount 'easyfranchisefreetier'  -region 'us10' -myemail 'alexander.rieder@sap.com'